...
public class HashWithProbing extends LocalJavaAnimation {
	...
	public class LPHashTableRendering implements Renderer<hash_set_QP<?>> {
	...
	hash_set_QP<SillyString> linear = new hash_set_QP<HashWithProbing.SillyString>();
	...
	public void buildMenu() {
		...
		registerStartingAction(new MenuFunction() {
			...
			public void selected() {
				...
				stk.render(hash_set_QP.class, new LPHashTableRendering());
		...
		register ("find", new MenuFunction() {
			...
			public void selected() {
				...
				out.println("Does " + value + " occurs in the table? " 
                    + linear.contains(new SillyString(value)));
			}
		});
